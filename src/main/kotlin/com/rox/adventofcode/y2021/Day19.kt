...
fun main() {
    ...
    //println("Part A: ${solutionA(puzzleInputFromFile("src/main/kotlin/com/rox/adventofcode/y2021/day19.input"))}")
    //println("Part B: ${com.rox.adventofcode.y2021.solutionB(puzzleInputFromFile("src/main/kotlin/com/rox/adventofcode/y2021/day19.input"))}")
}
...
private fun solutionA(input: String): Any {
    ...
    var report = mutableListOf<Scanner>()
    var scanner = mutableListOf<BeaconReport>()
    for (i in rows.indices){
        when {
            ...
            rows[i].startsWith("---") -> {
                ...
                val beaconDefinition = rows[i].split(",")
                scanner.add(Triple(beaconDefinition[0].toInt(), beaconDefinition[1].toInt(), beaconDefinition[2].toInt()))
            }
        }
    }
...
typealias Report = List<Scanner>
typealias Scanner = List<BeaconReport>
typealias BeaconReport = Triple<Int,Int,Int>
