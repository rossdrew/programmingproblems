...
fun main() {
    ...
    println("Part B: ${solutionB(puzzleInputFromFile("src/main/kotlin/com/rox/adventofcode/y2021/day1.input"))}")
}
 ...
 * sea floor. On a small screen, the sonar sweep report (your puzzle input) appears: each line is a measurement of
...
private fun solutionB(input: String): Any {
    ...
    var count = 0
    for (i in 1 until numbers.size) {
        val plus = if (i+1 >= numbers.size) 0 else numbers [i+1]
