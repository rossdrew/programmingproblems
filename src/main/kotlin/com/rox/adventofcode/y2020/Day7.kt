 ...
 * processing.
 *
 * Due to recent aviation regulations, many rules (your puzzle
 * input) are being enforced about bags and their contents; bags
 * must be color-coded and must contain specific quantities of
 * other color-coded bags. Apparently, nobody responsible for
...
private fun bag(name: String, children: List<Bag> = listOf()): Bag {
    val value = bagCatalogue.getOrDefault(name, Bag(name, children))
    bagCatalogue[name] = value
    return value
}
