...
public class Recursion1 {
    ...
    public String endX(String str) {
        ...
        return (isX ? "" : str.substring(0,1)) + endX(str.substring(1)) + (isX ? "x" : "");
    }
    ...
    public int countPairs(String str) {
        ...
        return countPairs(str.substring(1)) + ((str.charAt(0) == str.charAt(2)) ? 1 : 0);
    }
    ...
    public String stringClean(String str) {
        ...
        if (str.substring(0,1).equals(str.substring(1,2))){
            return stringClean(str.substring(0,1) + stringClean(str.substring(2)));
        }else{
    ...
    public static void main(String[] args){
        new Recursion1().countHi2("ahibhi");
    }
}
