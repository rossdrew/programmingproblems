...
public class Day8Test {
    private static final String INPUT = "a dec -511 if x >= -4\n" +
                                        "pq inc -45 if cfa == 7\n" +
                                        "vby dec 69 if tl < 1\n" +
                                        "yg dec 844 if v > -6\n" +
                                        "tl inc -756 if u != 9\n" +
    ...
    @Test
    public void testPart1SolutionFirstAttemptError(){
        // Some operations were being wrongly skipped.
        // Turns out I was using a==b when a and b where Integer so they were comparing object
        // references which seemed to fail predictably?!
        // (ewg dec 269 if u == 610) No operation. [u=610]
        // (x dec 210 if ss == -948) No operation. [ss=-948]
        // (tl inc -643 if vby == -847) No operation. [vby=-847]
        // (cfa dec -775 if pq == 172) No operation. [pq=172]
        // (pq dec 400 if pq == 172) No operation. [pq=172]
        // (q dec 876 if l == -267) No operation. [l=-267]
        // (l dec -884 if e == 483) No operation. [e=483]
        // (x inc 694 if vby == -587) No operation. [vby=-587]
        // (hnd inc -107 if vpd == -727) No operation. [vpd=-727]
        // (v dec 122 if jus == 291) No operation. [jus=291]
        // ...
        Day8 day = new Day8();
        assertEquals(611, day.part1Solution("c inc 610 if a == 0\n" +
                                                     "d inc 611 if c == 610\n"));
    }
    ...
    public void testPart1Solution(){
        Day8 day = new Day8();
        assertNotEquals(4555, day.part1Solution(INPUT)); //Attempt 1:  "Too Low"
