...
public class Day4Test {
    ...
    public void testPart1Solution(){
        ...
        assertEquals(466, day.part1Solution(INPUT));
    }

    @Test
    public void testPart2Example(){
        Day4 day = new Day4();
        assertFalse(day.hasAnagramPair("abcde fghij"));
        assertTrue("the letters from the third word can be rearranged to form the first word.", day.hasAnagramPair("abcde xyz ecdab"));
        assertFalse("all letters need to be used when forming another word.", day.hasAnagramPair("a ab abc abd abf abj"));
        assertTrue("any of these words can be rearranged to form any other word.", day.hasAnagramPair("oiii ioii iioi iiio"));
    }
